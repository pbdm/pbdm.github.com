...
export const MERMAID_PATH = [
  'http://cdn.bootcss.com/mermaid/7.0.0/mermaid.min.js',
  'http://cdn.bootcss.com/mermaid/7.0.0/mermaid.forest.min.css'
];

export const FLOWCHART_PATH = [
  'http://cdn.bootcss.com/flowchart/1.7.0/flowchart.min.js'
];
